...
const animateOnScroll = document.querySelectorAll('.skill-card, .project-card, .timeline-item, .contact-item, .education-card');
...
// Dynamic Particle Movement on Mouse Move
...
console.log('%cDeveloped by Sahil Sengra', 'color: #7b2ff7; font-size: 14px;');
